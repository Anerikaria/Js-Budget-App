  ...
  var  formatNumber = function(num, type) {
    ...
    return{
        ...
        var html, newHtml, element
            // Create HTML string  which holds some Placeholder texts
            if(type === 'inc'){
            ...
            // Replace the HTML string to the actual data
        ...
        displayMonth: function(){
            ...
            'May', 'June', 'July', 'Áugust', 'September',
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var ctrlAddItem = function(){
        ...
        if(input.description !== "" && input.description.trim().length !== 0  && !isNaN(input.value) && input.value > 0 ){
